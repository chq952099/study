                    ...
                    <el-tab-pane>
                        ...
                        <div class="course-container">
                            <div class="courseName">
                                {{ playCourseData.charpterName }}
                            </div>
                            <div class="courseDesc">{{ courseList.courseName }}</div>
                            <div class="courseImg">
                                <img :src="playCourseData.chapterLitpic" alt="" />
                            </div>
                            ...
                            <div class="teacher" v-if="true">
                                ...
                                <div class="teacherInfo">
                                    <div class="teacherName">{{ courseList.lecturerName }}</div>
                                    <div class="teacherTag">{{ courseList.tags }}</div>
                                </div>
                            </div>
                    ...
                    <el-tab-pane>
                        ...
                        <div class="chapter-container">
                            <dl class="list" v-for="item in bizCourseChapters" :key="item.id">
                                ...
                                <dd class="'active'" v-for="video in item.children" :key="video.id">
                                    <div class="video-itemIcon" ref="renderMap(child)">
                                        <i class="el-icon-video-camera"></i>
                                    </div>
                                    <div class="item-name">
                                        视频{{ video.chapterName }}
                                    </div>
                                </dd>
                            </dl>
                        </div>
...
// api
import { player } from '../utils/api/newCourse'
// 引入视屏播放插件
...
onBeforeMount(() => {
    player({
        ...
        console.log(res);
        playerData.value = res.data.playInfo
        playCourseData.value = res.data.chapterInfo
        courseList.value = res.data.courseInfo
