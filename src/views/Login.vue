            ...
            <div class="login-box">
                ...
                <div class="login-left">
                    ...
                    <div class="left-qrcode">
                        <div id="qrcode" title="小鹿线"><canvas width="180" height="180"
                                style="display: none;"></canvas><img src="" style="display: block;"></div>
...
// api  登录时发起post请求，
import { loginByJson,loginByMobile,getInfo} from '../utils/api/login'
...
let rulesPhone = reactive({
    phone: [
        ...
        { pattern: /^1[3456789]\d{9}$/, message: '目前只支持中国大陆手机号', trigger: 'blur' },
    ],
    captcha: [
...
const phoneBtn = (formEl) => {
    ...
    formEl.validate((valid, fields) => {
        if (valid) {
            ...
            let captcha=Encrypt(ruleFormPhone.captcha)
            loginByMobile({
                mobile,
                captcha
            }).then(res=>{
